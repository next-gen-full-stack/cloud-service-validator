...
public class NotificationValidationResult extends ServiceValidationResult {
  ...
  public String azurePing() {
    ...
    try {
      ...
      NotificationHub hub =
          new NotificationHub(
              "Endpoint=sb://notification.servicebus.chinacloudapi.cn/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=zkCl062hhgqCDngeIO10Kogf2Gyatj5+X3IZ3MzEYAU=",
              "notification-test");
  ...
  public String aliPing() throws ServerException, ClientException, IOException {
    ...
    InputStream inputStream =
        NotificationValidationResult.class
            .getClassLoader()
  ...
  public static void main(String[] args)
      throws NotificationHubsException, ServerException, ClientException, IOException {
